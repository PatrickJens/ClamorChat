...
function GetHandler()
{
    ...
    this.urls = [
        ...
        { url: '/bad-login.html', urn: './bad-login-signup-VC/bad-login.html'},
        { url: '/images/badLoginImage.png', urn: 'images/badLoginImage.png'},
        { url: '/bad-login-signup-controller.js', urn: './bad-login-signup-VC/bad-login-signup-controller.js'},
        { url: '/registration.html', urn: './bad-login-signup-VC/registration.html'}
    ] ;
